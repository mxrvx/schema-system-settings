...
/** @covers \MXRVX\Schema\System\Settings\TypeCasters\ArrayUniqueCaster */
class ArrayUniqueCasterTest extends BaseTest
{
    ...
    public function testTransformCorrect($value, $expected): void
    {
        ...
        $this->assertSame($expected, ArrayUniqueCaster::cast($value));
    }
    ...
    public function testTransformEmpty($value, $expected): void
    {
        ...
        $this->assertNull(ArrayUniqueCaster::cast($value));
    }
