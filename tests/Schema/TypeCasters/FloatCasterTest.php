...
/** @covers \MXRVX\Schema\System\Settings\TypeCasters\FloatCaster */
class FloatCasterTest extends BaseTest
{
    ...
    public function testTransformCorrect($value, $expected): void
    {
        ...
        $this->assertEquals($expected, FloatCaster::cast($value));
    }
    ...
    public function testTransformEmpty($value, $expected): void
    {
        ...
        $this->assertNull(FloatCaster::cast($value));
    }
