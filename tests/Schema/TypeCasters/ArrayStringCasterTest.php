...
/** @covers \MXRVX\Schema\System\Settings\TypeCasters\ArrayStringCaster */
class ArrayStringCasterTest extends BaseTest
{
    ...
    public function testTransformCorrect($value, $expected): void
    {
        ...
        $this->assertSame($expected, ArrayStringCaster::cast($value));
    }
    ...
    public function testTransformEmpty($value, $expected): void
    {
        ...
        $this->assertNull(ArrayStringCaster::cast($value));
    }
