...
/** @covers \MXRVX\Schema\System\Settings\TypeCasters\ListIntegerCaster */
class ListIntegerCasterTest extends BaseTest
{
    ...
    public function testTransformCorrect($value, $expected): void
    {
        ...
        $this->assertSame($expected, ListIntegerCaster::cast($value));
    }
    ...
    public function testTransformEmpty($value, $expected): void
    {
        ...
        $this->assertNull(ListIntegerCaster::cast($value));
    }
