...
/** @covers \MXRVX\Schema\System\Settings\TypeCasters\ListCaster */
class ListCasterTest extends BaseTest
{
    ...
    public function testTransformCorrect($value, $expected): void
    {
        ...
        $this->assertSame($expected, ListCaster::cast($value));
    }
    ...
    public function testTransformEmpty($value, $expected): void
    {
        ...
        $this->assertNull(ListCaster::cast($value));
    }
