...
/** @covers \MXRVX\Schema\System\Settings\TypeCasters\ArrayIntegerCaster */
class ArrayIntegerCasterTest extends BaseTest
{
    ...
    public function testTransformCorrect($value, $expected): void
    {
        ...
        $this->assertSame($expected, ArrayIntegerCaster::cast($value));
    }
    ...
    public function testTransformEmpty($value, $expected): void
    {
        ...
        $this->assertNull(ArrayIntegerCaster::cast($value));
    }
